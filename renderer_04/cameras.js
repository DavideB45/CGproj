...
FollowFromBackCamera = function(carObj){
    ...
    this.update = function(_car_position, wheelRor){
        ...
        glMatrix.mat4.fromRotation(this.smallRot, -this.orientation, [0, 1, 0.5]);
        this.eye = MultiplyMatrixVector(this.toWord, MultiplyMatrixVector(this.smallRot, [-this.orientation,   2,  4]));
